...
const getAppointmentByDate = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        appointmenObj = underscore_1.default.sortBy(appointmenObj, item => underscore_1.default.indexOf(Helpers_1.AppointStatusOrder, item === null || item === void 0 ? void 0 : item.appointmentStatus));
...
const addDoctor = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield approvalService.addDoctorAndHospitalToEachOthersProfile(doctorId, hospitalId);
        return (0, response_1.successResponse)({}, "Success", res);
    }
    catch (error) {
        return (0, response_1.errorResponse)(error, res);
...
const changeAppointmentStatus = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id, status } = req.body;
        yield hospitalService.changeAppointmentStatus(id, status);
        return (0, response_1.successResponse)({}, "Success", res);
    }
    catch (error) {
        return (0, response_1.errorResponse)(error, res);
...
const verifyHospitalPhoneNumber = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, Utils_1.verifyPhoneNumber)(req.currentHospital, "hospital");
        return (0, response_1.successResponse)({}, "Success", res);
    }
    catch (error) {
        return (0, response_1.errorResponse)(error, res);
...
exports.verifyHospitalPhoneNumber = verifyHospitalPhoneNumber;
const resendOtpToHospital = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
